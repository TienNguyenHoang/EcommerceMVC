...
namespace EcommerceMVC.Services
{
	public class VnPayService : IVnPayService
	{
		...
		public string CreatePaymentUrl(HttpContext context, VnPaymentRequestModel model, CheckoutVM checkoutVM)
		{
			...
			vnpay.AddRequestData("vnp_OrderInfo", $"{checkoutVM.ReceiverName}|{checkoutVM.Address}|{checkoutVM.Phone}|{checkoutVM.Note}");
